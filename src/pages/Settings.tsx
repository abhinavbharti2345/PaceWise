  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-300 max-w-3xl pb-20 sm:pb-0">
      ...
      <header className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[var(--color-dark)]">Settings & Preferences</h1>
          <p className="text-[var(--color-gray-dark)] text-sm">Manage account, currency, appearance, and categories.</p>
        </div>
      </header>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="flex items-center gap-3.5 min-w-0">
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-[var(--color-gray-dark)] truncate">
                Display name, avatar, and profile.
              </p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center gap-3.5 min-w-0">
            <div className="w-10 h-10 rounded-2xl bg-purple-500/10 text-purple-600 dark:text-purple-400 flex items-center justify-center font-bold shrink-0 group-hover:scale-105 transition-transform">
              <Tag size={20} />
            </div>
            <div className="min-w-0">
              <h3 className="text-sm font-bold text-[var(--color-dark)] group-hover:text-[var(--color-primary)] transition-colors truncate">
              ...
              <p className="text-xs text-[var(--color-gray-dark)] truncate">
                Manage expense, bill, & income tags.
              </p>
            </div>
          </div>
          <ChevronRight size={18} className="text-[var(--color-gray-dark)] group-hover:text-[var(--color-primary)] group-hover:translate-x-1 transition-all shrink-0 ml-2" />
        ...
        <div className="p-4 sm:p-6">
          ...
          <div className="grid grid-cols-3 gap-3 bg-[var(--color-surface-light)] p-1.5 rounded-2xl">
            <button 
              ...
              className={cn(
                "py-3 px-3 text-xs font-bold rounded-xl transition-all flex flex-col sm:flex-row justify-center items-center gap-2 cursor-pointer",
                config.theme === 'light' 
      ...
      <Card className="border border-[var(--color-gray-light)]">
        ...
        <div className="p-4 sm:p-6 space-y-4">
          ...
          <Button
            ...
            variant="outline"
            className="w-full flex items-center justify-center gap-2 font-bold text-red-600 hover:bg-red-50 dark:hover:bg-red-950/40 cursor-pointer"
          >
            <LogOut size={16} />
